        ...
        <div class="card">
            ...
            <div class="row mb-2">
              ...
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">Waiting Attendees</li>
              </ol>
          </div>
            </div>
            </div>
                ...
                <table class="table no-wrap user-table mb-0">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" class="border-0 text-uppercase font-medium">Confirmed at</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <span class="text-muted">{{$u->confirmed_at}}</span><br>
                          <!--<span class="text-muted">Past : teacher</span>-->
                      </td>
                    </tr>
                    @endforeach
